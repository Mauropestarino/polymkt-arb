...
const parsed = schema.parse({
  ...
  maxBookAgeMs: envOrArg("MAX_BOOK_AGE_MS", "300"),
  minOrderbookLevels: envOrArg("MIN_ORDERBOOK_LEVELS", "1"),
  executionOrderType: envOrArg("EXECUTION_ORDER_TYPE", "FOK")?.toUpperCase(),
  binaryArbExecutionMode: envOrArg("BINARY_ARB_EXECUTION_MODE", "FOK")?.toUpperCase(),
  executionTimeoutMs: envOrArg("EXECUTION_TIMEOUT_MS", "1500"),
  paperShadowLatencyMs: envOrArg("PAPER_SHADOW_LATENCY_MS", "150"),
